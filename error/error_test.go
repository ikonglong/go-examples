...
func operation() *opError {
	return nil
}

func Test_OpErrPtrNil_IsNil(t *testing.T) {
	err := operation()
	fmt.Printf("(nil *opError) is nil: %v\n", err == nil)
}
...
func Test_AfterAssignOpErrPtrNilToErrorIFace_IsNil(t *testing.T) {
	...
	err = operation()
	fmt.Printf("after assign (nil *opError) to (err error), err is nil: %v\n", err == nil)
}
...
func Test_AfterAssignOpErrPtrNilToCustomErrorIFace_IsNil(t *testing.T) {
	...
	err = operation()
	fmt.Printf("after assign (nil *opError) to (err customErr), err is nil: %v\n", err == nil)
}
...
func Test_stdlib_as_func(t *testing.T) {
	...
	var opErr opError
	fmt.Printf("opErr: %v\n", opErr)
	fmt.Printf("errors.As(err, (non-nil *opError)): %v\n", errors.As(err, &opErr))
	fmt.Printf("opErr: %v\n", opErr)
}
...
func Test_stdlib_is_func(t *testing.T) {
	...
	var opErr opError
	fmt.Printf("opErr: %v\n", opErr)
	fmt.Printf("errors.Is(err, (non-nil *opError)): %v\n", errors.Is(err, &opErr))
	fmt.Printf("opErr: %v\n", opErr)
